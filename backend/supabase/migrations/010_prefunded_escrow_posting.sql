-- Migration 010: Prefunded escrow at job posting
-- 1) Allow escrows.freelancer_id to be NULL until a seeker is accepted.
-- 2) Align escrow RLS with wallet context fallback (app config + request header).
