// API Route: Release Escrow Payment
// POST /api/aleo/escrow/release
// POST /api/escrows/:id/release (alternative route pattern)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { escrowId, employerPrivateKey, aleoAddress } = body;
